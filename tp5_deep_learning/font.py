...
# Configuración de colormap monocromático
monocromatic_cmap = plt.get_cmap('binary')

# Font 3: Caracteres desde ` (0x60) hasta DEL (0x7f)
font_3 = np.array([
...
def plot_character(encoded_caracter, cmap=None):
    if cmap is None:
        cmap = monocromatic_cmap
    
    bin_array = to_bin_array(encoded_caracter)
    heatmap(
        bin_array,
        linewidths=0.2,
        cbar=False,
