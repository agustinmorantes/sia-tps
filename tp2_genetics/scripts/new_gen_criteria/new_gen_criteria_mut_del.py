...
CONFIG_FILE = "./configs/new_gen_criteria/new_gen_criteria_mut_del_12.json"
OUTPUT_METRICS_FILE = "./metrics/new_gen_criteria_mut_del_12.csv"
OUTPUT_DIR = "./outputs/new_gen_criteria_mut_del_12"
